...
queries2 = {
    'radius': "FOR v IN 0..4 INBOUND 'Topics/249118' GRAPH 'TopicsGraph' RETURN v"
}

for q in queries2:
    queryResult = s.db.AQLQuery(queries2[q], rawResults=True)  # I believe rawResults=True ensures results are dicts
    print(q)
